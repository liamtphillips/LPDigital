...
export const accordionArray = [
    {
        ...
        accordionText: "Discover - Initial Due Diligence. Highlight 3-5 project aspects where your team requires external insights, faces concerns, or lacks prioritization due to time constraints. Understand - Identify Scope of Work We'll use the areas you outlined, project documentation, and a call between our teams to identify where we can provide immediate value and propose a 4-6 week engament plan. Execute - Internal Due Diligence Report We deliver a comprehensive report diving into your concerns and provide our insights, including mitigants, proposed solutions, and additional strategic insights we think your team should consider. Sustain - Post Report Analysis and Monitoring Our team views the audit as the first step in our consulting relationship. It allows both teams to get comfortable with one another before committing to a longer-term partnership where we work with your team in a closer capacity with a monthly retainer.",
        image: tech
    },
    {
        ...
        accordionText: "Protocol & Technology Evaluation: This aspect involves analyzing the underlying protocol and technology of the asset. It assesses factors such as the scalability, efficiency, security features, consensus mechanism, and any unique technological innovations employed by the project. Token Design & Distribution Analysis: Understanding the design and distribution of the token is critical for exchanges. This includes scrutinizing tokenomics, such as token supply, distribution mechanisms (e.g., ICO, airdrops, mining), utility within the ecosystem, governance mechanisms, and potential impact on market dynamics. Competitive Landscape Assessment: Examining the competitive landscape helps exchanges understand where the asset stands relative to similar projects or established competitors. This involves evaluating factors like market positioning, differentiation, user adoption, partnerships, and potential challenges in gaining market share.",
        image: asset
    }
]
