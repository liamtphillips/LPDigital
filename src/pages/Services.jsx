...
const Team = () => {
  ...
  >
      ...
      <h1 className='py-2 text-2xl md:text-5xl font-bold max-w-2xl'>Consulting Services</h1>
        <p className='text-md font-semibold lg:text-xl text-gray-400 max-w-xl mt-5 mb-10'
      ...
      <h1 className='py-2 text-5xl font-bold max-w-2xl'>The LP Advantage</h1>
        <p className='text-md font-semibold lg:text-xl text-gray-400 max-w-xl mt-5 mb-10'>Partnering with LP Digital means we become an integral part of your team, dedicated to assisting you in achieving your overarching objectives and mission.</p>
      </div>
        ...
        <div className='gap-4 flex flex-col'>
          ...
          {servicesArray.map(({ title, text }, index) => (
            <div className='bg-slate-900/50 backdrop-blur-sm flex flex-col p-10 rounded-xl max-w-7xl mx-auto' key={index}>
              ...
              <p className='text-gray-400 font-semibold text-xl mt-4'>{text}</p>
            </div>
          ))}
        </div>
      </div>
